<script lang="ts">
    ...
    // Badges: Core2 (ventas/reservas) + master (soporte "nuevo")
    ...
    // Realtime + sync de stores viven en nested-nav-runtime (equiv. a lo que master tenía inline)
    ...
    onMount(() => {
        ...
        // Badge Mensajes (master): sync + RT soporte
